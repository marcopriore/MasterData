...
class TenantORM(Base):
    ...
    max_description_length: Mapped[int] = mapped_column(
...
class MaterialDatabaseORM(Base):
    ...
    purchase_group: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    lead_time: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    mrp_type: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    ...
    valuation_class: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    valuation_group: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    standard_price: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    profit_center: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    sales_org: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    distribution_channel: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    sales_unit: Mapped[Optional[str]] = mapped_column(String(20), nullable=True)
    order_unit: Mapped[Optional[str]] = mapped_column(String(20), nullable=True)
    delivery_tolerance: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    preferred_supplier: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    mrp_controller: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    lot_size: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    forecast_profile: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    cst_ipi: Mapped[Optional[str]] = mapped_column(String(20), nullable=True)
    cst_pis_cofins: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    stock_account: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    price_control: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
