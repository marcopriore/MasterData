...
# Roles padrão para novo tenant (mesma estrutura do seed_data)
ONBOARDING_ROLE_DEFS = [
    ("ADMIN", "sistema", {
        "can_approve": True, "can_reject": True, "can_submit_request": True,
        "can_view_pdm": True, "can_edit_pdm": True, "can_view_workflows": True,
        "can_edit_workflows": True, "can_manage_users": True, "can_view_logs": True,
        "can_manage_fields": True, "can_view_database": True, "can_manage_roles": True,
        "can_standardize": True, "can_bulk_import": True,
    }),
    ("SOLICITANTE", "sistema", {
        "can_approve": False, "can_reject": False, "can_submit_request": True,
        "can_view_pdm": True, "can_edit_pdm": False, "can_view_workflows": False,
        "can_edit_workflows": False, "can_manage_users": False, "can_view_logs": False,
        "can_manage_fields": False, "can_view_database": True, "can_manage_roles": False,
        "can_standardize": False, "can_bulk_import": False,
    }),
    ("TRIAGEM", "etapa", {
        "can_approve": True, "can_reject": True, "can_submit_request": False,
        "can_view_pdm": True, "can_edit_pdm": False, "can_view_workflows": False,
        "can_edit_workflows": False, "can_manage_users": False, "can_view_logs": False,
        "can_manage_fields": False, "can_view_database": True, "can_manage_roles": False,
        "can_standardize": False, "can_bulk_import": False,
    ...
    ("FISCAL", "etapa", {
        "can_approve": True, "can_reject": True, "can_submit_request": False,
        "can_view_pdm": False, "can_edit_pdm": False, "can_view_workflows": False,
        "can_edit_workflows": False, "can_manage_users": False, "can_view_logs": False,
        "can_manage_fields": False, "can_view_database": True, "can_manage_roles": False,
        "can_standardize": False, "can_bulk_import": False,
    }),
    ("MASTER", "etapa", {
        ...
        "can_view_pdm": True, "can_edit_pdm": True, "can_view_workflows": True,
        "can_edit_workflows": True, "can_manage_users": True, "can_view_logs": True,
        "can_manage_fields": True, "can_view_database": True, "can_manage_roles": False,
        "can_standardize": True, "can_bulk_import": True,
    }),
    ("MRP", "etapa", {
        "can_approve": True, "can_reject": True, "can_submit_request": False,
...
# Etapas do workflow padrão (mesmo que seed_data WORKFLOW_STEPS)
...
# Field dictionary padrão SAP MM01 (31 campos do seed_data)
